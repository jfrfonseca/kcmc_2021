...
MODELS = {
    ...
    # 'min_flood',
    'min_flood__gurobi_single_flow': (gurobi_single_flow, False, 'min_flood'),
    'min_flood__gurobi_multi_flow': (gurobi_multi_flow, False, 'min_flood'),
    # 'max_flood',
    'max_flood__gurobi_single_flow': (gurobi_single_flow, False, 'max_flood'),
    'max_flood__gurobi_multi_flow': (gurobi_multi_flow, False, 'max_flood'),
    # 'reuse',
