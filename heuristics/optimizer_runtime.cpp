...
//                   duration, set_used_installation_spots);
    ...
    setify(set_used_installation_spots, &used_installation_spots);
    printout_short(instance, k, m, instance->num_sensors,
                   "dinic-reuse-" + std::to_string(num_paths),  // Add the number of added sensors for k-coverage
                   duration, set_used_installation_spots);
...
//                   duration, set_used_installation_spots);
    ...
    setify(set_used_installation_spots, &used_installation_spots);
    printout_short(instance, k, m, instance->num_sensors,
                   "dinic-flood-reuse-" + std::to_string(num_paths),  // Add the number of added sensors for k-coverage
                   duration, set_used_installation_spots);
    ...
    setify(set_used_installation_spots, &used_installation_spots);
    printout_short(instance, k, m, instance->num_sensors,
                   "dinic-best-" + std::to_string(num_paths),  // Add the number of added sensors for k-coverage
                   duration, set_used_installation_spots);
